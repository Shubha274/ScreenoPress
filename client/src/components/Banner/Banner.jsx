...
const Banner = () => {
  return (
    ...
    <div className="responsive flex justify-center relative">
      <img className="img-fluid " src={bannerImage} alt="banner2" />

      <div className="absolute inset-0 text-white flex flex-col items-start justify-center px-4 pb-12 md:pb-0 md:pl-16 lg:pl-24 space-y-2 md:space-y-4">
        <p className="text-xl ml-20 md:text-3xl lg:text-5xl font-semibold text-left leading-snug">
          From Thought to Print <br /> We Make It Real.
        </p>

        <p className="hidden md:block ml-20 text-sm md:text-base lg:text-lg text-left leading-snug">
          Enjoy Your Custom Prints
        </p>
